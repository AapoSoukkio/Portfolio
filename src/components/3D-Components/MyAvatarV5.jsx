...
Command: npx gltfjsx@6.2.7 public/MyAvatarV5.glb
*/

import React, { useEffect, useRef } from 'react'
import { useAnimations, useFBX, useGLTF } from '@react-three/drei'

export default function MyAvatarV5(props) {
  const group = useRef();
  ...
  return (
    <group {...props} ref={group}  scale={3.0} position={[-1.4, -0.4, -0.5]} rotation={[-1.2, 0, 0.4]} dispose={null}>
...
useGLTF.preload('/MyAvatarV5.glb')
